...
class EventData: ObservableObject {
    ...
    // MARK: Prepopulated array of Event for UI.
    ...
    // MARK: Methods for delete and add new Event in lists.
    ...
    // MARK: Filter and sorted all methods by its time.
...
// MARK: Time Period Enumeration for sorting the list
enum Period: String, CaseIterable, Identifiable {
    case nextSevenDays = "Next 7 Days"
    case nextThirtyDays = "Next Thirty Days"
    case future = "Future"
    case past = "Past"
...
extension Date {
    ...
    static func roundedHoursFromNow(_ hours: Double) -> Date {
        ...
        guard let hourRange = Calendar.current.dateInterval(of: .hour, for: exactDate) else { return exactDate }
